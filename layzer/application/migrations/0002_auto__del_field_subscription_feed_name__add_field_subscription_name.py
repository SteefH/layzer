...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscription.feed_name'
        db.delete_column(u'application_subscription', 'feed_name')

        # Adding field 'Subscription.name'
        db.add_column(u'application_subscription', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Subscription.feed_name'
        db.add_column(u'application_subscription', 'feed_name',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Deleting field 'Subscription.name'
        db.delete_column(u'application_subscription', 'name')
