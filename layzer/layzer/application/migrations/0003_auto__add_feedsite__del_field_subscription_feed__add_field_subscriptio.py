...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedSite'
        db.create_table(u'application_feedsite', (
        ...
        db.send_create_signal(u'application', ['FeedSite'])

        # Deleting field 'Subscription.feed'
        db.delete_column(u'application_subscription', 'feed_id')

        # Adding field 'Subscription.site'
        db.add_column(u'application_subscription', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['application.FeedSite']),
                      keep_default=False)

        # Deleting field 'Feed.name'
        db.delete_column(u'application_feed', 'name')

        # Deleting field 'Feed.site_url'
        db.delete_column(u'application_feed', 'site_url')


    def backwards(self, orm):
        # Deleting model 'FeedSite'
        db.delete_table(u'application_feedsite')

        # Adding field 'Subscription.feed'
        db.add_column(u'application_subscription', 'feed',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['application.Feed']),
                      keep_default=False)

        # Deleting field 'Subscription.site'
        db.delete_column(u'application_subscription', 'site_id')

        # Adding field 'Feed.name'
        db.add_column(u'application_feed', 'name',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Feed.site_url'
        db.add_column(u'application_feed', 'site_url',
    ...
    models = {
        ...
        u'application.feedsite': {
            'Meta': {'object_name': 'FeedSite'},
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['application.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'application.subscription': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['application.FeedSite']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'auth.group': {
