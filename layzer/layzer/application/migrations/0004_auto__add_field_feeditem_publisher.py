...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedItem.publisher'
        db.add_column(u'application_feeditem', 'publisher',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedItem.publisher'
        db.delete_column(u'application_feeditem', 'publisher')
    ...
    models = {
        ...
        u'application.feeditem': {
            ...
            'publisher': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True'}),
